    ...
    <>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
              <div className="text-sm font-medium text-orange-500 px-4 py-2 bg-orange-500/10 border border-orange-500/30 rounded-full inline-flex items-center gap-2 mb-8">
            ...
            <h2 className="text-6xl leading-tight font-bold text-white">استكشف حسب الموضوع</h2>
            <p className=" text-lg leading-relaxed text-neutral-400 max-w-lg mx-auto">
