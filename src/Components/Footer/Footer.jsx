          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <form className="space-y-3">
                ...
                <button type="submit" className="w-full cursor-pointer font-semibold text-white transition-all duration-300 justify-center items-center inline-flex px-8 py-4 bg-linear-135 from-[#f97316] to-[#ea580c] rounded-full text-sm">
                  اشترك
                </button>
              </form>
            </div>
