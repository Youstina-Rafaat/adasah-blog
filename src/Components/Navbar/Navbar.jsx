        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Link
                className="cursor-pointer font-semibold text-white transition-all duration-300 justify-center items-center inline-flex px-8 py-4 bg-linear-135 from-[#f97316] to-[#ea580c] rounded-full text-sm"
                to="blog"
                data-discover="true"
              >
                ابدأ القراءة
          ...
          <div className="md:hidden overflow-hidden transition-all duration-300 max-h-0">
            <div className="bg-[#161616] backdrop-blur-xl rounded-2xl p-4 border border-[#262626]">
              <div className="flex flex-col space-y-1">
                ...
                <NavLink
                  className="cursor-pointer font-semibold text-white transition-all duration-300 justify-center items-center inline-flex px-8 py-4 bg-linear-135 from-[#f97316] to-[#ea580c] rounded-full text-sm text-center mt-2"
                  to="blog"
                  data-discover="true"
                >
                  ابدأ القراءة
