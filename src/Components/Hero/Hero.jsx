        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight tracking-tight">
              اكتشف <span className="bg-linear-135 from-[#f97316] to-[#fbbf24] bg-clip-text text-transparent">فن</span>
              <br />
              التصوير الفوتوغرافي
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
              <Link
                className="cursor-pointer font-semibold text-white transition-all duration-300  px-8 py-4 bg-linear-135 from-[#f97316] to-[#ea580c] rounded-full inline-flex items-center justify-center gap-2 group"
                to="/blog"
                data-discover="true"
              >
              ...
              <Link
                className="cursor-pointer px-8 py-4 font-semibold text-white transition-all duration-300 bg-[#0000] border border-[#333] rounded-full inline-flex items-center justify-center gap-2"
                to="/about"
                data-discover="true"
              >
                <svg
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              <div
                className="rounded-3xl bg-[#161616cc] border border-[#262626] p-4 hover:scale-105 transition-transform duration-300"
                style={{ animationDelay: "0ms" }}
              >
                <i className="fa-solid fa-newspaper text-2xl text-orange-500 mb-1" />
                <p className="text-2xl md:text-3xl font-bold bg-linear-135 from-[#f97316] to-[#fbbf24] bg-clip-text text-transparent">
                  +50
                </p>
                <p className="text-neutral-500 text-sm">مقالة</p>
              </div>
              <div
                className="p-4 rounded-3xl bg-[#161616cc] border border-[#262626] hover:scale-105 transition-transform duration-300"
